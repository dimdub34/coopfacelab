...
class CFResults(Page):
    ...
    def vars_for_template(self):
        return {"CF_period_selected_for_pay":
                ...
                "CF_choose_cooperator": self.player.in_round(
                    self.player.participant.vars["CF_period_selected_for_pay"]).CF_choose_cooperator}
...
page_sequence = [
    Instructions, InstructionsRead,
    PGDecision, PGResultsWaitPage, PGResults, PGEnd,
    Instructions, InstructionsRead,
    CFDecision, CFResults, CFEnd,
    Demographic,
    Final, Final_after_comments]
